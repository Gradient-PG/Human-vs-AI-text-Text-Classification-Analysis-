...
\midrule
GPT-4   & $0.985 \pm 0.004$ & $+0.41 \pm 0.42$\,pp \\
GPT-2   & $0.948 \pm 0.004$ & $+3.63 \pm 0.81$\,pp \\
MPT     & $0.960 \pm 0.004$ & $+4.68 \pm 1.14$\,pp \\
Mistral & $0.966 \pm 0.004$ & $+0.93 \pm 0.42$\,pp \\
LLaMA   & $0.980 \pm 0.004$ & $+1.14 \pm 0.43$\,pp \\
Cohere  & $0.887 \pm 0.009$ & $+4.43 \pm 1.02$\,pp \\
\bottomrule
\end{tabular}%
}
...
\begin{tabular}{lrrrrr}
\toprule
Family & $n_{\text{stable}}$ & Full\,L2 & Sel\,L2 & Sel/Full & AUC \\
\midrule
cohere  & 119 & 88.6\% & 76.3\% & 86\% & 0.946 \\
gpt     &  91 & 98.2\% & 88.8\% & 90\% & 0.993 \\
llama   & 125 & 99.7\% & 93.7\% & 94\% & 0.999 \\
mistral & 106 & 96.6\% & 85.6\% & 89\% & 0.982 \\
mpt     & 110 & 99.1\% & 85.7\% & 87\% & 0.995 \\
\bottomrule
\end{tabular}
...
neurons retain.
Sel\,L2 AUC ranges from 0.863 (cohere) to 0.986 (llama).
...
We encode each text with \bertbase\ using HuggingFace Transformers. The input is truncated to 512 WordPiece tokens. We extract the CLS-token hidden state from \emph{all} 12 transformer layers and concatenate them into a single vector $\mathbf{z} \in \mathbb{R}^{9{,}216}$ ($12 \times 768$). Gradients are disabled throughout; BERT weights are never updated.
